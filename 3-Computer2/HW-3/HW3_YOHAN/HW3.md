...
- 범용 레지스터의 예시
  ...
  > 64비트 환경에서는 rax, rbx, rcx, rdx, rbp, rsp, rsi, rdi 에다가 8개의 레지스터(r8 ~ r15)를 추가로 가진다
   ...
   ![image-memory123](register12.jpg)
...
### 결과(VS)
 ...
 ![image-code_result12](vs_code_result1.jpg)

 ![image-code_result22](vs_code_result2.jpg)

 ![image-code_result32](vs_code_result3.jpg)

 ![image-code_result42](vs_code_result4.jpg)

...
약 인공지능인 알파고도 인류에서 바둑으로는 최정상인 이세돌을 이겼습니다. 그런데 강인공지능이 해킹을 학습하기 시작하고 그 해킹을 악용한다면 어떻게 될까요? 인류는 이미 IT 기술에 많이 의존하고 있기 때문에 돌이킬 수 없는 세상이 올 수도 있습니다. 그렇다면 이 상황에서 컴퓨터 보안을 하는 인공지능을 만들기 위하여 컴퓨터 보안공부를 해보자 라는 조심스러운 추측성 결론을 내릴 수도 있습니다.
